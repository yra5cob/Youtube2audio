...
$(document).ready(function () {
    (function (window, undefined) {
        ...
        var AudioPlayer = (function () {
            ...
            function changeDocumentTitle(title) {
                if (settings.changeDocTitle) {
                    if (title) {
                        ...
                        $('.no_album_img').css('background-image', 'url(' + playList[index].icon + ')');
                    } else {
            ...
            function updateAndPlay(addList) {
                console.log("here");
                if (!apActive) {
                    return 'Player is not yet initialized';
                }
                console.log(Array.isArray(addList));
            ...
            function play(currentIndex) {
                ...
                // Toggle play button
                playStyle();
                //Path.setAttribute('d', playSvg.getAttribute('data-pause'));
            ...
            function playStyle() {
                $('#play_circle').addClass('glyphicon-pause').removeClass('glyphicon-play');
                $('#npAction').text(function (i, text) {
                    if (text === "PAUSED...") {
                        return "NOW PLAYING";
                    }
            ...
            function playToggle() {
                ...
                if (audio.paused) {
                    ...
                    console.log(playList[index].icon);
                    changeDocumentTitle(playList[index].title);
